...
public class ColouredDiamondsMod
{
	...
	public final static Block blockBrownDiamondBlock = new blockBrownDiamondBlock (4062, 12, Material.iron).setHardness(5F).setStepSound(Block.soundMetalFootstep).setBlockName("blockBrownDiamondBlock").setCreativeTab(DiamondsTab.tabDiamondsMod);
	public final static Block blockGreenDiamondBlock = new blockGreenDiamondBlock (4063, 13, Material.iron).setHardness(5F).setStepSound(Block.soundMetalFootstep).setBlockName("blockGreenDiamondBlock").setCreativeTab(DiamondsTab.tabDiamondsMod);
